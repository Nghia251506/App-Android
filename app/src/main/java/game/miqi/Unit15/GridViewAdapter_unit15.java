...
public class GridViewAdapter_unit15 extends BaseAdapter{
    Context context;
    char[]kitu;
    int[]dapan;
Game_unit15 mainActivity;


    public GridViewAdapter_unit15(Context context, char[] kitu,int[]dapan,Game_unit15 mainActivity) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(dapan[mainActivity.list.get(mainActivity.stt)]==position)
                {
                    ...
                    mainActivity.adpater = new GridViewAdapter_unit15(context,mainActivity.capnhat(mainActivity.list.get(mainActivity.stt)),dapan,mainActivity);
